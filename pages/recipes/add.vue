...
v-if="preview"
class="img-fluid"
style="width: 400px; border-radius: 10px; box-shadow: 0 1rem 1rem
rgba(0,0,0,.7);"
:src="preview"
alt
>
...
<input v-model="recipe.prep_time" type="number" class="form-
control">
...
<textarea v-model="recipe.prep_guide" class="form-control"
rows="8"></textarea>
</div>
